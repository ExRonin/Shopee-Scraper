...
if($getSearch->error == null) {
    ...
    for ($x = 0; $x < $totalSearch; $x++) {
        ...
        $getItem = getItem($curl, $itemID, $shopID);
            ...
            echo $no . '. [Status barang = ' . $status . '], [Sold = ' . $sold. '], [Ongkir = ' . $statusongkir. '], [Jumlah gambar = ' . $arraygambar. '], [Harga Barang = ' . $priceItem . '],  [Nama Barang = ' . $nameItem . '], [Lokasi toko = ' . $lokasiToko . '], [Gambar = ' . $imageItem . "] \n";
